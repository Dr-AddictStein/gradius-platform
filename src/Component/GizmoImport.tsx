...
interface GizmoImportModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (subject: string, color: string) => void;
}

const GizmoImportModal: React.FC<GizmoImportModalProps> = ({
  isOpen,
  onClose,
}) => {
          ...
          <div className="relative w-[48%] h-full">
            ...
            <div className="absolute top-3 left-3">
              <button className="h-[38px] w-[145px] bg-[#202123] flex items-center justify-around rounded-[6px]">
                <img src="../../public/gizmoLogo.png" alt="" />
...
export default GizmoImportModal;
