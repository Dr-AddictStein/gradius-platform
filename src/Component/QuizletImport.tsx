          ...
          <div className="relative w-[48%] h-full">
            <div className="h-full flex flex-col justify-between  ">
              <div className="h-[70%]">
                ...
                <div className="w-full border-2 border-[#565868] h-full rounded-[6px] flex flex-col items-center justify-center">
              ...
              <div className="h-[10%] w-full flex justify-center items-center">
                <button className="bg-[#A436F1] h-[40px] w-[138px] rounded-[6px] flex justify-center gap-5 items-center">
