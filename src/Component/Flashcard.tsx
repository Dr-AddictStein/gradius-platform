...
const Flashcard = () => {
  ...
  return (
    <div className="h-full w-full " style={containerStyle}>
      <div className="relative w-full h-full bg-[#3D3F4A] rounded-[6px]" style={cardStyle}>
        {/* Question Side */}
        <div className="absolute w-full h-full" style={questionStyle}>
        ...
        {/* Answer Side */}
        <div className="absolute w-full h-full" style={answerStyle}>
          <div className="relative w-full h-full p-4 flex justify-center">
              ...
              <div className="w-full mb-3 flex justify-between gap-4">
                <div className="relative w-1/3">
                  <button
                    ...
                    onClick={() => diff === "Easy" ? setDiff("") : setDiff("Easy")}
                  >
                    <p className="font-bold lg:text-[16px] text-[10px] text-center">
                      Easy
                    </p>
