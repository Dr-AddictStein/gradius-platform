          ...
          <div className="w-full flex flex-col items-center justify- gap-4">
            ...
            <div className="relative w-full h-[50px]">
              ...
              <button
                ...
                className={`flex w-full h-full justify-between px-8 items-center rounded-[6px] border-[1px] border-slate-600 ${
                ...
                <div className="w-[95%] flex flex-col justify-end items-end gap-2">
                  ...
                  <div
                    onClick={() => {
                      ...
                      setSubjects([...subjects, { id: "1", name: "Physics", isActive: false, color: "red" }])
                    }}
                  ...
                  <div className="w-full max-h-[200px] overflow-y-auto scrollbar-hide px-2 py-2">
                    {subjects.map((subject) => (
                      <div
                        ...
                        onClick={() => {
                          navigate(`/tutorial/perSubject/${subject.name}`);
          ...
          <div className="w-full h-[160px] bg-[#343540] rounded-md p-3 flex flex-col items-center justify-around">
            ...
            >
              ...
              <div className="flex flex-col items-start justify-center">
                <div className="xl:text-[12px] lg:text-[10px] text-[10px] font-semibold">
                  {user.name}
                </div>
            ...
            <button
              ...
              className=" hover:shadow-[0_0_15px_2px_#A436F1] transition-shadow duration-300 w-[90%] h-[40px] py-2 bg-[#A436F1] rounded-lg flex items-center justify-center gap-2 text-white"
            >
