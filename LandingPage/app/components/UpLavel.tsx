...
const UpLavel = () => {
  return (
    <Zoom delay={1} duration={2000}>
        <div
      className="max-w-5xl relative overflow-hidden bg-[#22013a]   rounded-lg h-[300px]  shadow-lg w-full my-16 p-10 mx-auto mt-8 bg-cover bg-center"
    ...
    >
      <div className=" text-white">
        ...
        <h1 className="text-center text-[#F3ECFE] mt-7 text-4xl z-50">One-size-doesn’t-fit-all <br /> Level up now!</h1>
